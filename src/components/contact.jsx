...
export const Contact = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        'service_o7uxg54', 'template_gm6iqtk', e.target, 'user_cMQEkqyoRzQp766l9ch6i'
      )
      .then(
        (result) => {
          ...
          <div className='col-md-8'>
            <div className='row'>
              <div className='section-title'>
                ...
                <p>
                Completa el formulario a continuación para enviarme un correo electrónico y me pondré en contacto lo antes posible.
                </p>
              </div>
